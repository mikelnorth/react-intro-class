...
class Calculator extends Component {
    ...
    setDisplay(num){
            ...
            var display = (this.state.display === '0') ? num :
            this.state.display + num;
            this.setState({display: (this.state.display.length < 13) ?
    ...
    setOperator(operator) {
      ...
      calculate(){
        ...
        switch ( this.state.operator ) {
            case '+':
            result = this.state.temp + parseInt
            (this.state.display, 10)
            break;
            case '-':
            result = this.state.temp - parseInt
            (this.state.display, 10)
